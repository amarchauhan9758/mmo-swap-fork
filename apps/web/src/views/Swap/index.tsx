...
const CHART_SUPPORT_CHAIN_IDS = [ChainId.BSC, ChainId.BSC_TESTNET, ChainId.MATIC]
export const ACCESS_TOKEN_SUPPORT_CHAIN_IDS = [ChainId.BSC]
 
const STABLE_SUPPORT_CHAIN_IDS = [ChainId.BSC_TESTNET, ChainId.BSC, ChainId.MATIC]
