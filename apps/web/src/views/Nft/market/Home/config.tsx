  ...
  return [
    {
      ...
      description: [
        t(
          'Trades are settled in WBNB, which is a wrapped version of Matic used on Matic Polygon. That means that when you sell an item, WBNB is sent to your wallet instead of BNB.',
        ),
        t('You can instantly swap your WBNB for BNB with no trading fees on MMO Swap.'),
      ],
    },
    {
    ...
    },
    {
      ...
      description: [
        t(
          '100% of all platform fees taken by MMO Swap from sales are used to buy back and BURN CAKE tokens in our weekly CAKE burns.',
        ),
        t(
