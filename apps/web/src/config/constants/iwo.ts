...
import { Iwo } from './types'

export const cakeBnbLpToken = new ERC20Token(ChainId.MATIC, CAKE_BNB_LP_MAINNET, 18, 'CAKE-BNB LP')
...
const iwos: Iwo[] = [
  ...
  //   isActive: true,
  //   name: 'Knight',
  //   subTitle: 'Knight is the prominent decentralized exchange (DEX) on Binance Smart Chain that focuses on providing the highest quality Decentralized Finance (DeFi) experience.',
  //   description:
  //     'At KNIGHT we help investors stack their riches & unlock the ability to earn multiple passive income streams. To do so, investors are incentivized to provide liquidity on the KNIGHT platform through yield farming to earn the native currency, $KNIGHT. Investors can then use their earned $KNIGHT tokens to stake in Markets to earn partner tokens. $KNIGHT will also be used for many other features that can be found within the platform. The possibilities are endless but one thing’s for sure there will always be a shot for the moon at KNIGHT.',
  //   launchDate: '2nd November',
  //   launchTime: '5:00 PM UTC',
  //   saleAmount: '2,000,000 KNIGHT',
  //   raiseAmount: '$500000',
  //   cakeToBurn: '$75000',                         // it is wizard buyback
  //   projectSiteUrl: 'https://knightswap.financial',
  //   currency: 'BUSD',
  ...
  //   subTitle:
  //     'Knight is the prominent decentralized exchange (DEX) on Binance Smart Chain that focuses on providing the highest quality Decentralized Finance (DeFi) experience.',
  //   description:
  //     'At KNIGHT we help investors stack their riches & unlock the ability to earn multiple passive income streams. To do so, investors are incentivized to provide liquidity on the KNIGHT platform through yield farming to earn the native currency, $KNIGHT. Investors can then use their earned $KNIGHT tokens to stake in Markets to earn partner tokens. $KNIGHT will also be used for many other features that can be found within the platform. The possibilities are endless but one thing’s for sure there will always be a shot for the moon at KNIGHT.',
  //   launchDate: '2nd November',
  //   launchTime: '5:00 PM UTC',
