...
import { bscTokens, bscTestnetTokens, USDC, USDT, BUSD, WBTC_ETH, maticTokens } from '@pancakeswap/tokens'
...
export const ROUTER_ADDRESS: ChainMap<string> = {
  ...
  [ChainId.BSC_TESTNET]: '0x28A0b738D49222c0E8a5B2F7CF2CfE4a7407e2F6',
  [ChainId.MATIC]: '0x5aEd353BbcBD2FFE2f63e7C0FaC425BAdDB1984E',
}
...
export const BASES_TO_CHECK_TRADES_AGAINST: ChainTokenList = {
  ...
  [ChainId.MATIC]: [maticTokens.wmatic, maticTokens.usdc, maticTokens.mmo],
...
export const SUGGESTED_BASES: ChainTokenList = {
  ...
  [ChainId.BSC_TESTNET]: [bscTestnetTokens.wbnb, bscTestnetTokens.busd, bscTestnetTokens.mmo],
  [ChainId.MATIC]: [maticTokens.usdc, maticTokens.mmo],
}
...
export const BASES_TO_TRACK_LIQUIDITY_FOR: ChainTokenList = {
  ...
  [ChainId.BSC_TESTNET]: [bscTestnetTokens.wbnb, bscTestnetTokens.cake, bscTestnetTokens.busd],
  [ChainId.MATIC]: [maticTokens.wmatic, maticTokens.mmo, maticTokens.usdc],
}
...
export const PINNED_PAIRS: { readonly [chainId in ChainId]?: [Token, Token][] } = {
  ...
  [ChainId.MATIC]: [
    [maticTokens.mmo, maticTokens.wmatic],
    [maticTokens.wmatic, maticTokens.usdc],
    [maticTokens.mmo, maticTokens.usdc],
  ],
}
